...
services --enabled=auditd,ntpd,ntpdate,iptables,network,rsyslog,multipathd,snmpd,cgconfig,mcelog,tuned,libvirtd --disabled=netfs,ovirt-awake,libvirt-guests,kdump
